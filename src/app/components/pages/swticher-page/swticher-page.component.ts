...
@Component({
  selector: 'app-swticher-page',
  templateUrl: './swticher-page.component.html',
  styleUrls: ['./swticher-page.component.scss']
})
export class SwticherPageComponent implements OnInit {
